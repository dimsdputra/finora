            ...
            <XAxis
              ...
              tickFormatter={(value, index) => {
                ...
                const isMobile =
                  ...
                  ((window.innerWidth >= 300 && window.innerWidth <= 604) ||
                    (window.innerWidth >= 768 && window.innerWidth <= 1280));
                const isFirst = index === 0;
                const isLast = chartData.length - 1 === index;
                ...
                if (
                  ...
                  // Only show day for first and last tick
                  return (isFirst || isLast) && date.getDate()
                    ? format(date, "d")
                    : "";
                }
